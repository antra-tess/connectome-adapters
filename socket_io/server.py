...
class SocketIOServer:
    ...
    def __init__(self):
        ...
        self.rate_limit_messages = self.config.get_setting("rate_limit", "messages_per_second")
        self.rate_limit_window = self.config.get_setting("rate_limit", "window_seconds")
    ...
    async def _apply_rate_limiting(self) -> None:
        ...
        if time_since_last < (self.rate_limit_window / self.rate_limit_messages):
            wait_time = (self.rate_limit_window / self.rate_limit_messages) - time_since_last
