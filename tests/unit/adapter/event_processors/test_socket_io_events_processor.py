...
from adapter.event_processors.socket_io_events_processor import SocketIoEventsProcessor, EventType
...
class TestSocketIoEventsProcessor:
    ...
    @pytest.fixture
    def processor(self, telethon_client_mock, conversation_manager_mock, uploader_mock):
        """Create a SocketIoEventsProcessor with mocked dependencies"""
        with patch("adapter.event_processors.socket_io_events_processor.Uploader") as UploaderMock:
            UploaderMock.return_value = uploader_mock
            processor = SocketIoEventsProcessor(telethon_client_mock, conversation_manager_mock)
            return processor
