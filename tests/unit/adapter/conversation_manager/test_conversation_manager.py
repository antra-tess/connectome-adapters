...
from adapter.conversation_manager.conversation_data_classes import ConversationInfo, UserInfo
from cache.message_cache import CachedMessage
...
class TestConversationManager:
    ...
    @pytest.fixture
    def conversation_manager(self, mock_message_cache, mock_attachment_cache):
        """Create a ConversationManager with mocked dependencies"""
        with patch("adapter.conversation_manager.conversation_manager.MessageCache", return_value=mock_message_cache):
            with patch("adapter.conversation_manager.conversation_manager.AttachmentCache", return_value=mock_attachment_cache):
