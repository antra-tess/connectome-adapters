...
class TestMessageCache:
    ...
    def message_cache(self, config_mock):
        ...
        with patch('cache.message_cache.Config') as ConfigMock:
    ...
    class TestConversationMigrationFunctionality:
        ...
        async def test_message_migration(self, message_cache, sample_messages_info):
            ...
            conv_1_msg_count = len(message_cache.messages["conv_1"])

            await message_cache.migrate_messages("conv_1", "conv_3")

            assert "conv_1" not in message_cache.messages
            assert "conv_3" in message_cache.messages
            assert len(message_cache.messages["conv_3"]) == conv_1_msg_count
