...
from cache.attachment_cache import AttachmentCache, CachedAttachment
...
class TestAttachmentCache:
    ...
    def attachment_cache(self, config_mock):
        ...
        with patch('cache.attachment_cache.Config') as ConfigMock:
    ...
    class TestAttachmentProperties:
        ...
        @pytest.fixture
        def mock_storage_dir_config(self):
            """Create a mocked Config instance for path tests"""
            with patch('cache.attachment_cache.Config') as ConfigMock:
                get_instance = MagicMock()
                get_instance.get_setting.return_value = "test_storage_dir"
                ConfigMock.return_value.get_instance.return_value = get_instance
                yield

        def test_file_path_with_extension(self, cached_attachment, mock_storage_dir_config):
        ...
        def test_file_path_without_extension(self, cached_attachment, mock_storage_dir_config):
        ...
        def test_metadata_path(self, cached_attachment, mock_storage_dir_config):
    ...
    class TestUploadExistingAttachments:
        ...
        def test_load_attachments(self, config_mock, test_storage_dir, test_attachment_structure):
    ...
    class TestAddAttachment:
        ...
        async def test_add_existing_attachment_new_conversation(self, attachment_cache, sample_attachment_info):
            ...
            print(attachment_cache.attachments)
