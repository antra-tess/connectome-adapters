...
class Manager(BaseManager):
    ...
    async def _update_message(self,
        ...
        if edited_timestamp:
            edited_timestamp = datetime.strptime(
                edited_timestamp, "%Y-%m-%dT%H:%M:%S.%f%z"
            )
        else:
    ...
    async def _get_conversation_to_migrate_from(self, event: Any) -> Optional[ConversationInfo]:
        """Get the old conversation from an event. Not applicable for Discord"""
        pass

    async def _get_conversation_to_migrate_to(self, event: Any) -> Optional[ConversationInfo]:
        """Get the new conversation from an event. Not applicable for Discord"""
        pass

    def _get_messages_to_migrate(self,
                                 event: Any,
                                 old_conversation: Optional[ConversationInfo] = None) -> List[str]:
        """Get the messages to migrate. Not applicable for Discord"""
        pass
    ...
    def _perform_migration_related_updates(self,
                                           ...
                                           message_id: str) -> None:
        """Perform migration related updates. Not applicable for Discord"""
        pass
