...
class TestUserBuilder:
    ...
    @pytest.mark.asyncio
    async def test_add_user_info_to_conversation_stream(self, config_mock, mock_stream_message, conversation_info):
    ...
    @pytest.mark.asyncio
    async def test_add_user_info_to_conversation_private(self, config_mock, mock_private_message, conversation_info):
    ...
    @pytest.mark.asyncio
    async def test_add_user_info_to_conversation_existing(self, config_mock, mock_stream_message, conversation_info):
