...
class Manager(BaseManager):
    ...
    async def _process_event(self,
        ...
        if event_type in [SlackEventType.ADDED_REACTION, SlackEventType.REMOVED_REACTION]:
    ...
    async def _get_conversation_to_migrate_from(self, event: Any) -> Optional[ConversationInfo]:
        ...
        Not applicable for Slack because there is no concept of migrating conversations.
        """
        raise NotImplementedError("Migrating conversations is not applicable for Slack")
