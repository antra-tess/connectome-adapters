...
class TestUserBuilder:
    ...
    def test_add_known_members_to_private_conversation(self, config_mock, mock_private_message, conversation_info):
        ...
        assert bot_user.is_bot is True  # Should be True because it matches adapter ID and email
    ...
    def test_add_user_info_to_conversation_stream(self, config_mock, mock_stream_message, conversation_info):
        """Test adding a user from a stream message"""
        result = UserBuilder.add_user_info_to_conversation(
    ...
    def test_add_user_info_to_conversation_private(self, config_mock, mock_private_message, conversation_info):
    ...
    def test_add_user_info_to_conversation_existing(self, config_mock, mock_stream_message, conversation_info):
