...
class TestIncomingEventProcessor:
    ...
    @pytest.fixture
    def processor(self, patch_config, zulip_client_mock, conversation_manager_mock, rate_limiter_mock):
        """Create a ZulipIncomingEventProcessor with mocked dependencies"""
        processor = IncomingEventProcessor(patch_config, zulip_client_mock, conversation_manager_mock)
