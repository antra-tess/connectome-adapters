...
class TestSocketIOToTelegramFlowIntegration:
    ...
    async def test_add_reaction_flow(self,
        ...
        with patch(
                 "adapters.telegram_adapter.adapter.event_processors.socket_io_events_processor.functions"
             ) as mock_functions, \
             patch(
                 "adapters.telegram_adapter.adapter.event_processors.socket_io_events_processor.ReactionEmoji"
