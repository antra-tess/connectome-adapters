...
from adapters.telegram_adapter.adapter.event_processors.telegram_events_processor import (
    TelegramEventsProcessor, EventType
)
...
class TestTelegramEventsProcessor:
    ...
    def processor(self, patch_config, telethon_client_mock, conversation_manager_mock):
        ...
        with patch("adapters.telegram_adapter.adapter.event_processors.telegram_events_processor.Downloader") as DownloaderMock:
            DownloaderMock.return_value = AsyncMock()
            DownloaderMock.return_value.download_attachment = AsyncMock(return_value={})
            yield TelegramEventsProcessor(
                patch_config,
