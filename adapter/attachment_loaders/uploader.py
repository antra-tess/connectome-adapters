...
class Uploader(BaseLoader):
    ...
    def __init__(self, client):
        ...
        BaseLoader.__init__(self, client)
    ...
    async def upload_attachment(self,
        ...
        try:
            ...
            if metadata:
                attachment_dir = self._create_attachment_dir(
                    metadata["attachment_type"], metadata["attachment_id"]
                )
                ...
                self._delete_empty_directory(attachment["file_path"])
