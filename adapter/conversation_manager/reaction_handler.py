...
from adapter.conversation_manager.conversation_data_classes import ConversationDelta, UpdateType
...
class ReactionHandler:
    ...
    @staticmethod
    def update_message_reactions(message: Any,
